    ...
    <section className='max-w-7xl mx-auto px-4 py-16 md:py-24'>
        ...
        <div className='flex flex-col md:flex-row items-center justify-between gap-12 md:gap-24'>
            ...
            <div className='md:w-1/2 w-full'>
                ...
                <p className='text-gray-600 mb-8'>Take control of your time and boost productivity with our intelligent schedule system. Automate appointments, manage team availability, and deliver exceptional customer experiences through seamless calendar management.</p>
